...
function updateDisplay(symbol, newLine = false){
  let currentValue = document.getElementById('calcScreen').innerHTML;
  let digitCount = currentValue.split('');;

  if(currentValue == '0' || newLine){
    document.getElementById('calcScreen').innerHTML = symbol;
  }else{
...
function handleInput(e){
  ...
  const displayValue = document.getElementById('calcScreen').innerHTML;
